...
let
  ...
  self = stdenv.mkDerivation rec {
    ...
    patches = [
      ...
      (fetchpatch {
        name = "0005-fix-some-warnings.patch";
        url = "https://gitlab.freedesktop.org/pipewire/pipewire/commit/63a3811aa76802e9585e04cf12bf8de617442105.patch";
        sha256 = "sha256-TraIVVU4lE/qfliCTSCdHwoXSq2I4btbNRKjGZjnsuI=";
      })
      (fetchpatch {
